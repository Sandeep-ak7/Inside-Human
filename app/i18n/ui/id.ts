...
export const ui: UiDictionary = {
  meta: {
    title: "Inside Human — Belajar anatomi seperti seorang seniman",
    description:
      "Jelajahi organ 3D dengan detail medis — jantung, otak, paru-paru, hati, ginjal, mata, usus, pankreas, dan kulit — dalam studio anatomi interaktif.",
    ogTitle: "Inside Human — Belajar anatomi seperti seorang seniman",
    ogDescription: "Pelajari anatomi seperti seorang seniman melalui spesimen 3D yang imersif dan detail secara medis.",
    imageAlt: "Spesimen jantung anatomis melayang di atas alas, di samping logo Inside Human",
  },
  brand: { tagline: "Belajar anatomi seperti seorang seniman", home: "Beranda Inside Human" },
