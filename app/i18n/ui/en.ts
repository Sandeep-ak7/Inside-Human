...
export const ui: UiDictionary = {
  meta: {
    title: "Inside Human — Learn anatomy like an artist",
    description:
      "Explore medically detailed 3D organs — heart, brain, lungs, liver, kidneys, eye, intestine, pancreas, and skin — through an elegant, interactive anatomy studio.",
    ogTitle: "Inside Human — Learn anatomy like an artist",
    ogDescription: "Learn anatomy like an artist through immersive, medically detailed 3D specimens.",
    imageAlt: "An anatomical heart specimen floating above a plinth, beside the Inside Human wordmark",
  },
  brand: { tagline: "Learn anatomy like an artist", home: "Inside Human home" },
