...
export const ui: UiDictionary = {
  meta: {
    title: "Inside Human — Apprendre l'anatomie comme un artiste",
    description:
    ...
    ogTitle: "Inside Human — Apprendre l'anatomie comme un artiste",
    ogDescription: "Apprenez l'anatomie comme un artiste grâce à des spécimens 3D immersifs et médicalement détaillés.",
    imageAlt: "Un cœur anatomique flottant au-dessus d'un socle, à côté du logotype Inside Human",
  },
  brand: { tagline: "Apprendre l'anatomie comme un artiste", home: "Accueil d'Inside Human" },
