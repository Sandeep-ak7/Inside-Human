...
export const ui: UiDictionary = {
  meta: {
    title: "Inside Human — учить анатомию как художник",
    description:
      "Исследуйте медицински достоверные 3D-органы — сердце, мозг, лёгкие, печень, почки, глаз, кишечник, поджелудочную железу и кожу — в интерактивной анатомической студии.",
    ogTitle: "Inside Human — учить анатомию как художник",
    ogDescription: "Изучайте анатомию как художник — на подробных трёхмерных препаратах.",
    imageAlt: "Анатомический препарат сердца, парящий над подставкой, рядом с логотипом Inside Human",
  },
  brand: { tagline: "Учить анатомию как художник", home: "Главная страница Inside Human" },
