...
export const ui: UiDictionary = {
  meta: {
    title: "Inside Human — Aprende anatomía como un artista",
    description:
    ...
    ogTitle: "Inside Human — Aprende anatomía como un artista",
    ogDescription: "Aprende anatomía como un artista con especímenes 3D inmersivos y médicamente detallados.",
    imageAlt: "Un corazón anatómico flotando sobre un pedestal, junto al logotipo de Inside Human",
  },
  brand: { tagline: "Aprende anatomía como un artista", home: "Inicio de Inside Human" },
