...
export const ui: UiDictionary = {
  meta: {
    title: "Inside Human — تعلَّم التشريح كما يفعل الفنان",
    description:
    ...
    ogTitle: "Inside Human — تعلَّم التشريح كما يفعل الفنان",
    ogDescription: "تعلَّم التشريح كما يفعل الفنان عبر عيّنات ثلاثية الأبعاد غنية بالتفاصيل الطبية.",
    imageAlt: "عيّنة قلب تشريحية تطفو فوق قاعدة، إلى جانب شعار Inside Human",
  },
  brand: { tagline: "تعلَّم التشريح كما يفعل الفنان", home: "الصفحة الرئيسية لـ Inside Human" },
