...
export const ui: UiDictionary = {
  meta: {
    title: "Inside Human — Aprenda anatomia como um artista",
    description:
    ...
    ogTitle: "Inside Human — Aprenda anatomia como um artista",
    ogDescription: "Aprenda anatomia como um artista com espécimes 3D imersivos e ricos em detalhe médico.",
    imageAlt: "Um coração anatômico flutuando sobre um pedestal, ao lado da marca Inside Human",
  },
  brand: { tagline: "Aprenda anatomia como um artista", home: "Página inicial do Inside Human" },
