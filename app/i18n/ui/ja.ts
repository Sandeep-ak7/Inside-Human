...
export const ui: UiDictionary = {
  meta: {
    title: "Inside Human — 芸術家のように解剖学を学ぶ",
    description:
      "心臓・脳・肺・肝臓・腎臓・眼・腸・膵臓・皮膚——医学的に精緻な 3D 標本を、インタラクティブな解剖スタジオで探索できます。",
    ogTitle: "Inside Human — 芸術家のように解剖学を学ぶ",
    ogDescription: "没入感のある、医学的に精緻な 3D 標本で解剖学を学びましょう。",
    imageAlt: "台座の上に浮かぶ解剖学的な心臓標本と、Inside Human のロゴ",
  },
  brand: { tagline: "芸術家のように解剖学を学ぶ", home: "Inside Human ホーム" },
