...
export const ui: UiDictionary = {
  meta: {
    title: "Inside Human — Anatomie lernen wie ein Künstler",
    description:
      "Erkunde medizinisch detaillierte 3D-Organe — Herz, Gehirn, Lunge, Leber, Nieren, Auge, Darm, Bauchspeicheldrüse und Haut — in einem interaktiven Anatomie-Studio.",
    ogTitle: "Inside Human — Anatomie lernen wie ein Künstler",
    ogDescription: "Lerne Anatomie wie ein Künstler – mit immersiven, medizinisch detaillierten 3D-Präparaten.",
    imageAlt: "Ein anatomisches Herzpräparat über einem Sockel, daneben der Schriftzug Inside Human",
  },
  brand: { tagline: "Anatomie lernen wie ein Künstler", home: "Startseite von Inside Human" },
